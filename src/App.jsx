...
function App() {
  ...
  let content = <SelectedProject project={selectedProject} onDelete={handleDeleteProject} onAddTask={handleAddTask} onDeleteTask={handleDeletTask} tasks={projectsState.tasks} />;
